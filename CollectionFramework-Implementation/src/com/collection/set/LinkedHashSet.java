...
public class LinkedHashSet {
	public static void main(String[] args) {
		 ...
		 * 3.size is DYNAMIC 
		 * 4.we can not access the elements by index (not index-basing
		 * collection) 
		 * 5.if we want to access elements of hashSet so first we have to
		 * converted into arrayList 
		 * 6.we can traverse both type safe or unType safe of
		 * collections 
